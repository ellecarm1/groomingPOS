      ...
      <div className="mx-auto max-w-[1180px] px-5 pb-12 sm:px-8 lg:px-12">
        <header className="flex items-center justify-between border-b border-[#dfe1d8] py-6">
          <Link to="/" className="flex items-center gap-3">
            ...
            <div>
              <p className="font-display text-[17px] font-bold tracking-[-0.04em] text-[#234438]">good & groomed</p>
              <p className="text-[10px] font-bold uppercase tracking-[0.2em] text-[#89938a]">Book a visit</p>
            </div>
          </Link>
        ...
        <div className="mb-8 pt-10 sm:pt-14">
          ...
          <div className="mt-5 flex flex-col justify-between gap-4 md:flex-row md:items-end">
            <div>
              <p className="text-[11px] font-extrabold uppercase tracking-[0.16em] text-[#d2765d]">Step 03 · Pick a time</p>
              <h1 className="mt-2 font-display text-[clamp(2.4rem,5vw,4.4rem)] font-bold leading-[0.95] tracking-[-0.07em] text-[#234438]">Find a good time.</h1>
        ...
        <div className="grid gap-5 lg:grid-cols-[minmax(0,1fr)_340px]">
          ...
          <aside className="h-fit rounded-[28px] bg-[#234438] p-6 text-[#f8f4e8] shadow-[0_30px_70px_-32px_rgba(20,48,38,0.85)] sm:p-7 lg:sticky lg:top-6">
            ...
            <h2 className="mt-1 font-display text-2xl font-bold tracking-[-0.045em]">Almost there.</h2>
